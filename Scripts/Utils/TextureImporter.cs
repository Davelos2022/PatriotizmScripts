...
//        /// <returns></returns>
//        public static async UniTask<Texture2D> ImportTexture(string texturePath, FREE_IMAGE_FORMAT format, int mipLevels = -1)
//        {
//            var data = await UniTask.RunOnThreadPool<RawTextureData>(() => { return ImportTextureFromFile(texturePath, format, mipLevels); });
...
//        /// /// <param name="mipLevels">(optional) Number of mip levels. The default is -1 (auto)</param>
//        /// <returns></returns>
//        public static async UniTask<Texture2D> ImportTexture(byte[] textureData, FREE_IMAGE_FORMAT format, int mipLevels = -1)
//        {
//            var data = await UniTask.RunOnThreadPool<RawTextureData>(() => { return ImportTextureFromMemory(textureData, format, mipLevels); });
//            return CreateTexture(data);
//        }

//        private static RawTextureData ImportTextureFromFile(string texturePath, FREE_IMAGE_FORMAT format, int mipLevels)
//        {
...
//        private static RawTextureData ImportTextureFromMemory(byte[] textureBytes, FREE_IMAGE_FORMAT format, int mipLevels)
//        {
...
//        private static RawTextureData ImportTextureData(IntPtr texHandle, int mipLevels)
//        {
...
//        private static void GenerateMipMaps(IntPtr texHandle, RawTextureData texData)
//        {
...
//        private static Texture2D CreateTexture(RawTextureData texData)
//        {
//            if (texData == null)
//                return null;
